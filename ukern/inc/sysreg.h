...
// SPSR
#define SPSR_EL3h	0b1101		// el3 using sp_el3
#define SPSR_EL3t	0b1100		// el3 using sp_el0
#define SPSR_EL2h	0b1001		// el2 using sp_el2
#define SPSR_EL2t	0b1000		// el2 using sp_el0
#define SPSR_EL1h	0b0101		// el1 using sp_el1
#define SPSR_EL1t	0b0100		// el1 using sp_el0
#define SPSR_EL0t	0b0000		// el0 using sp_el0
#define SPSR_RW		(1 << 4)
#define SPSR_F		(1 << 6)
#define SPSR_I		(1 << 7)
#define SPSR_A		(1 << 8)
